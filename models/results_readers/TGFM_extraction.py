...
identifier = os.getenv("TGFM_identifier")
eqtl_sample_size = os.getenv("eqtl_sample_size")
result_root_dir = f"/PATH/TO/{identifier}/sum_stats_{eqtl_sample_size}/TGFM_results/"
...
np.savetxt(f"{result_root_dir}/pips_TGFM_{identifier}.csv", pips_all, delimiter=",", fmt="%.6f")